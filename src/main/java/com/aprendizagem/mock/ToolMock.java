...
public class ToolMock implements CommandLineRunner{
	...
	Tool tool4 = new Tool(null, "Notion", "https://notion.so", "ll in one tool to organize teams and ideas. "
			+ "Write, plan, collaborate, and get organized.", "api json rest");
	toolRepository.saveAll(Arrays.asList(tool1, tool2, tool3, tool4));
